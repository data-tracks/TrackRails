...
impl<'a> KeyValueStringTransform<'a> {
  ...
  pub fn key(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(KeyValueStringTransform::VT_KEY, None)}
  }
  #[inline]
  pub fn value(&self) -> Option<Transform<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Transform>>(KeyValueStringTransform::VT_VALUE, None)}
  }
}
...
impl flatbuffers::Verifiable for KeyValueStringTransform<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<Transform>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> Source<'a> {
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Source::VT_NAME, None)}
  }
  #[inline]
  pub fn type_(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Source::VT_TYPE_, None)}
  }
}
...
impl<'a> Destination<'a> {
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Destination::VT_NAME, None)}
  }
  #[inline]
  pub fn type_(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Destination::VT_TYPE_, None)}
  }
}
...
impl<'a> KeyValueU64Source<'a> {
  ...
  #[inline]
  pub fn value(&self) -> Option<Source<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Source>>(KeyValueU64Source::VT_VALUE, None)}
  }
}
...
impl flatbuffers::Verifiable for KeyValueU64Source<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<u64>("key", Self::VT_KEY, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<Source>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> KeyValueU64Destination<'a> {
  ...
  #[inline]
  pub fn value(&self) -> Option<Destination<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Destination>>(KeyValueU64Destination::VT_VALUE, None)}
  }
}
...
impl flatbuffers::Verifiable for KeyValueU64Destination<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<u64>("key", Self::VT_KEY, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<Destination>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> Bind<'a> {
  ...
  pub fn plan_id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Bind::VT_PLAN_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn stop_id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Bind::VT_STOP_ID, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> BindBuilder<'a, 'b, A> {
  ...
  pub fn add_plan_id(&mut self, plan_id: u64) {
    self.fbb_.push_slot::<u64>(Bind::VT_PLAN_ID, plan_id, 0);
  }
  #[inline]
  pub fn add_stop_id(&mut self, stop_id: u64) {
    self.fbb_.push_slot::<u64>(Bind::VT_STOP_ID, stop_id, 0);
  }
  #[inline]
...
impl<'a> Unbind<'a> {
  ...
  pub fn plan_id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Unbind::VT_PLAN_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn stop_id(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Unbind::VT_STOP_ID, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> UnbindBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_plan_id(&mut self, plan_id: u64) {
    self.fbb_.push_slot::<u64>(Unbind::VT_PLAN_ID, plan_id, 0);
  }
  #[inline]
  pub fn add_stop_id(&mut self, stop_id: u64) {
    self.fbb_.push_slot::<u64>(Unbind::VT_STOP_ID, stop_id, 0);
  }
  #[inline]
