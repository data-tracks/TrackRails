...
impl<'a> Status<'a> {
  ...
  pub fn msg(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Status::VT_MSG, None).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StatusBuilder<'a, 'b, A> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<Status<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, Status::VT_MSG,"msg");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> Message<'a> {
  ...
  pub fn status(&self) -> Status<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Status>>(Message::VT_STATUS, None).unwrap()}
  }
  #[inline]
  #[allow(non_snake_case)]
...
impl flatbuffers::Verifiable for Message<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<Status>>("status", Self::VT_STATUS, true)?
     .finish();
    Ok(())
  }
}
