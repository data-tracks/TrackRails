...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MIN_VALUES_OR_EVENTS: u8 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_VALUES_OR_EVENTS: u8 = 2;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_VALUES_OR_EVENTS: [ValuesOrEvents; 3] = [
  ValuesOrEvents::NONE,
...
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct ValuesOrEvents(pub u8);
#[allow(non_upper_case_globals)]
impl ValuesOrEvents {
  pub const NONE: Self = Self(0);
  pub const Values: Self = Self(1);
...
impl core::fmt::Debug for ValuesOrEvents {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> flatbuffers::Follow<'a> for ValuesOrEvents {
  type Inner = Self;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    let b = flatbuffers::read_scalar_at::<u8>(buf, loc);
...
impl flatbuffers::Push for ValuesOrEvents {
    type Output = ValuesOrEvents;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        flatbuffers::emplace_scalar::<u8>(dst, self.0);
    }
...
impl flatbuffers::EndianScalar for ValuesOrEvents {
  type Scalar = u8;
  #[inline]
  fn to_little_endian(self) -> u8 {
    self.0.to_le()
...
impl<'a> flatbuffers::Verifiable for ValuesOrEvents {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl flatbuffers::SimpleToVerifyInSlice for ValuesOrEvents {}
pub struct ValuesOrEventsUnionTableOffset {}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_EVENT: u8 = 3;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_EVENT: [Event; 4] = [
  Event::NONE,
  Event::Insert,
  Event::Delete,
  Event::Update,
...
impl Payload {
  ...
  pub const CreatePlanResponse: Self = Self(2);
  pub const DeletePlanRequest: Self = Self(3);
  pub const DeletePlanResponse: Self = Self(4);
  pub const StartPlanRequest: Self = Self(5);
  pub const StartPlanResponse: Self = Self(6);
  pub const StopPlanRequest: Self = Self(7);
  pub const StopPlanResponse: Self = Self(8);
  pub const GetPlanRequest: Self = Self(9);
  pub const GetPlansRequest: Self = Self(10);
  pub const Train: Self = Self(11);
  pub const Catalog: Self = Self(12);
  pub const RegisterRequest: Self = Self(13);
  pub const RegisterResponse: Self = Self(14);
  pub const BindRequest: Self = Self(15);
  pub const BindResponse: Self = Self(16);
  pub const UnbindRequest: Self = Self(17);
  pub const UnbindResponse: Self = Self(18);
  pub const Disconnect: Self = Self(19);
  ...
  pub const ENUM_VALUES: &'static [Self] = &[
    ...
    Self::CreatePlanResponse,
    Self::DeletePlanRequest,
    Self::DeletePlanResponse,
    Self::StartPlanRequest,
    Self::StartPlanResponse,
    Self::StopPlanRequest,
    Self::StopPlanResponse,
    Self::GetPlanRequest,
    Self::GetPlansRequest,
    Self::Train,
    Self::Catalog,
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::CreatePlanResponse => Some("CreatePlanResponse"),
      Self::DeletePlanRequest => Some("DeletePlanRequest"),
      Self::DeletePlanResponse => Some("DeletePlanResponse"),
      Self::StartPlanRequest => Some("StartPlanRequest"),
      Self::StartPlanResponse => Some("StartPlanResponse"),
      Self::StopPlanRequest => Some("StopPlanRequest"),
      Self::StopPlanResponse => Some("StopPlanResponse"),
      Self::GetPlanRequest => Some("GetPlanRequest"),
      Self::GetPlansRequest => Some("GetPlansRequest"),
...
impl<'a> Values<'a> {
  ...
  pub fn values(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ValueWrapper<'a>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ValueWrapper>>>>(Values::VT_VALUES, None).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ValuesBuilder<'a, 'b, A> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<Values<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, Values::VT_VALUES,"values");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> Events<'a> {
  ...
  #[inline]
  pub fn events(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<EventWrapper<'a>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<EventWrapper>>>>(Events::VT_EVENTS, None).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for Events<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<EventWrapper>>>>("events", Self::VT_EVENTS, true)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EventsBuilder<'a, 'b, A> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<Events<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, Events::VT_EVENTS,"events");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub enum TrainContentOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct TrainContent<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for TrainContent<'a> {
  type Inner = TrainContent<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> TrainContent<'a> {
  pub const VT_DATA_TYPE: flatbuffers::VOffsetT = 4;
  pub const VT_DATA: flatbuffers::VOffsetT = 6;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    TrainContent { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args TrainContentArgs
  ) -> flatbuffers::WIPOffset<TrainContent<'bldr>> {
    let mut builder = TrainContentBuilder::new(_fbb);
    if let Some(x) = args.data { builder.add_data(x); }
    builder.add_data_type(args.data_type);
    builder.finish()
  }
  ...
  #[inline]
  pub fn data_type(&self) -> ValuesOrEvents {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ValuesOrEvents>(TrainContent::VT_DATA_TYPE, Some(ValuesOrEvents::NONE)).unwrap()}
  }
  #[inline]
  pub fn data(&self) -> flatbuffers::Table<'a> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(TrainContent::VT_DATA, None).unwrap()}
  }
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_values(&self) -> Option<Values<'a>> {
    if self.data_type() == ValuesOrEvents::Values {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_events(&self) -> Option<Events<'a>> {
    if self.data_type() == ValuesOrEvents::Events {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { Events::init_from_table(u) })
    } else {
      None
    }
  }
...
impl flatbuffers::Verifiable for TrainContent<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<ValuesOrEvents, _>("data_type", Self::VT_DATA_TYPE, "data", Self::VT_DATA, true, |key, v, pos| {
        match key {
          ValuesOrEvents::Values => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Values>>("ValuesOrEvents::Values", pos),
          ValuesOrEvents::Events => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Events>>("ValuesOrEvents::Events", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
pub struct TrainContentArgs {
    pub data_type: ValuesOrEvents,
    pub data: Option<flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>>,
}
impl<'a> Default for TrainContentArgs {
  #[inline]
  fn default() -> Self {
    TrainContentArgs {
      data_type: ValuesOrEvents::NONE,
      data: None, // required field
    }
  }
}

pub struct TrainContentBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TrainContentBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_data_type(&mut self, data_type: ValuesOrEvents) {
    self.fbb_.push_slot::<ValuesOrEvents>(TrainContent::VT_DATA_TYPE, data_type, ValuesOrEvents::NONE);
  }
  #[inline]
  pub fn add_data(&mut self, data: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TrainContent::VT_DATA, data);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> TrainContentBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    TrainContentBuilder {
      fbb_: _fbb,
      start_: start,
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<TrainContent<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, TrainContent::VT_DATA,"data");
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for TrainContent<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("TrainContent");
      ds.field("data_type", &self.data_type());
      match self.data_type() {
        ValuesOrEvents::Values => {
        ...
        ValuesOrEvents::Events => {
          if let Some(x) = self.data_as_events() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
...
impl<'a> Train<'a> {
  ...
  #[inline]
  pub fn content(&self) -> TrainContent<'a> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<TrainContent>>(Train::VT_CONTENT, None).unwrap()}
  }
  #[inline]
...
impl flatbuffers::Verifiable for Train<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<TrainContent>>("content", Self::VT_CONTENT, true)?
...
pub struct TrainArgs<'a> {
    pub content: Option<flatbuffers::WIPOffset<TrainContent<'a>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TrainBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_content(&mut self, content: flatbuffers::WIPOffset<TrainContent<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<TrainContent>>(Train::VT_CONTENT, content);
  }
  #[inline]
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<Train<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, Train::VT_CONTENT,"content");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> Disconnect<'a> {
  ...
  pub fn id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Disconnect::VT_ID, Some(0)).unwrap()}
  }
}
...
impl<'a> Default for DisconnectArgs {
  #[inline]
  fn default() -> Self {
    DisconnectArgs {
      id: 0,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DisconnectBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: u64) {
    self.fbb_.push_slot::<u64>(Disconnect::VT_ID, id, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> DisconnectBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    DisconnectBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> RegisterResponse<'a> {
  ...
  pub const VT_CATALOG: flatbuffers::VOffsetT = 8;
  ...
  #[inline]
  pub fn permissions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RegisterResponse::VT_PERMISSIONS, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for RegisterResponse<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<u64>("id", Self::VT_ID, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>("permissions", Self::VT_PERMISSIONS, false)?
...
pub struct RegisterResponseArgs<'a> {
    pub id: Option<u64>,
    pub permissions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RegisterResponseBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_permissions(&mut self, permissions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RegisterResponse::VT_PERMISSIONS, permissions);
  }
  #[inline]
...
impl<'a> EventWrapper<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args EventWrapperArgs
  ) -> flatbuffers::WIPOffset<EventWrapper<'bldr>> {
  ...
  pub fn event_type(&self) -> Event {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Event>(EventWrapper::VT_EVENT_TYPE, Some(Event::NONE)).unwrap()}
  }
  #[inline]
  pub fn event(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(EventWrapper::VT_EVENT, None)}
  }
  #[inline]
  #[allow(non_snake_case)]
  pub fn event_as_insert(&self) -> Option<Insert<'a>> {
    if self.event_type() == Event::Insert {
      self.event().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { Insert::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn event_as_delete(&self) -> Option<Delete<'a>> {
    if self.event_type() == Event::Delete {
      self.event().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn event_as_update(&self) -> Option<Update<'a>> {
    if self.event_type() == Event::Update {
      self.event().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { Update::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_union::<Event, _>("event_type", Self::VT_EVENT_TYPE, "event", Self::VT_EVENT, false, |key, v, pos| {
        match key {
          Event::Insert => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Insert>>("Event::Insert", pos),
          Event::Delete => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Delete>>("Event::Delete", pos),
          Event::Update => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Update>>("Event::Update", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
pub struct EventWrapperBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EventWrapperBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_event_type(&mut self, event_type: Event) {
    self.fbb_.push_slot::<Event>(EventWrapper::VT_EVENT_TYPE, event_type, Event::NONE);
  }
  #[inline]
  pub fn add_event(&mut self, event: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(EventWrapper::VT_EVENT, event);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> EventWrapperBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    EventWrapperBuilder {
      fbb_: _fbb,
      start_: start,
  ...
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("EventWrapper");
      ...
      match self.event_type() {
        ...
        Event::Delete => {
          if let Some(x) = self.event_as_delete() {
            ds.field("event", &x)
          } else {
            ds.field("event", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Event::Update => {
          if let Some(x) = self.event_as_update() {
            ds.field("event", &x)
          } else {
            ds.field("event", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
...
impl<'a> flatbuffers::Follow<'a> for Insert<'a> {
  type Inner = Insert<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
...
impl<'a> Insert<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args InsertArgs<'args>
  ) -> flatbuffers::WIPOffset<Insert<'bldr>> {
    let mut builder = InsertBuilder::new(_fbb);
    if let Some(x) = args.value { builder.add_value(x); }
    builder.finish()
  }
  ...
  #[inline]
  pub fn value(&self) -> Option<ValueWrapper<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<ValueWrapper>>(Insert::VT_VALUE, None)}
  }
}

impl flatbuffers::Verifiable for Insert<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<ValueWrapper>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
pub struct InsertArgs<'a> {
    pub value: Option<flatbuffers::WIPOffset<ValueWrapper<'a>>>,
}
impl<'a> Default for InsertArgs<'a> {
  #[inline]
  fn default() -> Self {
    InsertArgs {
      value: None,
...
pub struct InsertBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> InsertBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_value(&mut self, value: flatbuffers::WIPOffset<ValueWrapper<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<ValueWrapper>>(Insert::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> InsertBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    InsertBuilder {
      fbb_: _fbb,
      start_: start,
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<Insert<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for Insert<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("Insert");
      ds.field("value", &self.value());
      ds.finish()
  }
}
...
impl<'a> Delete<'a> {
  ...
  #[inline]
  pub fn identity(&self) -> Option<ValueWrapper<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<ValueWrapper>>(Delete::VT_IDENTITY, None)}
  }
}
...
impl flatbuffers::Verifiable for Delete<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<ValueWrapper>>("identity", Self::VT_IDENTITY, false)?
     .finish();
    Ok(())
  }
}
pub struct DeleteArgs<'a> {
    pub identity: Option<flatbuffers::WIPOffset<ValueWrapper<'a>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DeleteBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_identity(&mut self, identity: flatbuffers::WIPOffset<ValueWrapper<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<ValueWrapper>>(Delete::VT_IDENTITY, identity);
  }
  #[inline]
...
impl<'a> Update<'a> {
  ...
  pub fn value(&self) -> Option<ValueWrapper<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<ValueWrapper>>(Update::VT_VALUE, None)}
  }
  #[inline]
  pub fn identity(&self) -> Option<ValueWrapper<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<ValueWrapper>>(Update::VT_IDENTITY, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> UpdateBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_value(&mut self, value: flatbuffers::WIPOffset<ValueWrapper<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<ValueWrapper>>(Update::VT_VALUE, value);
  }
  #[inline]
  pub fn add_identity(&mut self, identity: flatbuffers::WIPOffset<ValueWrapper<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<ValueWrapper>>(Update::VT_IDENTITY, identity);
  }
  #[inline]
...
impl<'a> CreatePlanResponse<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args CreatePlanResponseArgs
  ...
  pub fn id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(CreatePlanResponse::VT_ID, Some(0)).unwrap()}
  }
}
...
impl<'a> Default for CreatePlanResponseArgs {
  #[inline]
  fn default() -> Self {
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CreatePlanResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: u64) {
    self.fbb_.push_slot::<u64>(CreatePlanResponse::VT_ID, id, 0);
  }
  #[inline]
...
pub enum DeletePlanRequestOffset {}
#[derive(Copy, Clone, PartialEq)]
...
impl<'a> flatbuffers::Follow<'a> for DeletePlanRequest<'a> {
  type Inner = DeletePlanRequest<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> DeletePlanRequest<'a> {
  ...
  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    DeletePlanRequest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args DeletePlanRequestArgs
  ) -> flatbuffers::WIPOffset<DeletePlanRequest<'bldr>> {
    let mut builder = DeletePlanRequestBuilder::new(_fbb);
    builder.add_id(args.id);
    builder.finish()
  }
  ...
  pub fn id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(DeletePlanRequest::VT_ID, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for DeletePlanRequest<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> Default for DeletePlanRequestArgs {
  #[inline]
  fn default() -> Self {
    DeletePlanRequestArgs {
      id: 0,
    }
  }
}

pub struct DeletePlanRequestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DeletePlanRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: u64) {
    self.fbb_.push_slot::<u64>(DeletePlanRequest::VT_ID, id, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> DeletePlanRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<DeletePlanRequest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for DeletePlanRequest<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("DeletePlanRequest");
      ds.field("id", &self.id());
      ds.finish()
  }
}
pub enum DeletePlanResponseOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct DeletePlanResponse<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for DeletePlanResponse<'a> {
  type Inner = DeletePlanResponse<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> DeletePlanResponse<'a> {

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    DeletePlanResponse { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    _args: &'args DeletePlanResponseArgs
  ) -> flatbuffers::WIPOffset<DeletePlanResponse<'bldr>> {
    let mut builder = DeletePlanResponseBuilder::new(_fbb);
    builder.finish()
  }

}

impl flatbuffers::Verifiable for DeletePlanResponse<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct DeletePlanResponseArgs {
}
impl<'a> Default for DeletePlanResponseArgs {
  #[inline]
  fn default() -> Self {
    DeletePlanResponseArgs {
    }
  }
}

pub struct DeletePlanResponseBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DeletePlanResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> DeletePlanResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    DeletePlanResponseBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<DeletePlanResponse<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for DeletePlanResponse<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("DeletePlanResponse");
      ds.finish()
  }
}
...
pub enum GetPlansRequestOffset {}
#[derive(Copy, Clone, PartialEq)]
...
impl<'a> flatbuffers::Follow<'a> for GetPlansRequest<'a> {
  type Inner = GetPlansRequest<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> GetPlansRequest<'a> {
  ...
  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    GetPlansRequest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args GetPlansRequestArgs<'args>
  ) -> flatbuffers::WIPOffset<GetPlansRequest<'bldr>> {
    let mut builder = GetPlansRequestBuilder::new(_fbb);
    if let Some(x) = args.name { builder.add_name(x); }
    builder.finish()
  }
  ...
  pub fn name(&self) -> Option<Filter<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Filter>>(GetPlansRequest::VT_NAME, None)}
  }
}

impl flatbuffers::Verifiable for GetPlansRequest<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct GetPlansRequestArgs<'a> {
    pub name: Option<flatbuffers::WIPOffset<Filter<'a>>>,
}
impl<'a> Default for GetPlansRequestArgs<'a> {
  #[inline]
  fn default() -> Self {
    GetPlansRequestArgs {
      name: None,
...
pub struct GetPlansRequestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetPlansRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<Filter<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Filter>>(GetPlansRequest::VT_NAME, name);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> GetPlansRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    GetPlansRequestBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<GetPlansRequest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for GetPlansRequest<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("GetPlansRequest");
      ds.field("name", &self.name());
      ds.finish()
  }
}
pub enum GetPlanRequestOffset {}
#[derive(Copy, Clone, PartialEq)]
...
impl<'a> flatbuffers::Follow<'a> for GetPlanRequest<'a> {
  type Inner = GetPlanRequest<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> GetPlanRequest<'a> {
  ...
  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    GetPlanRequest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args GetPlanRequestArgs
  ) -> flatbuffers::WIPOffset<GetPlanRequest<'bldr>> {
    let mut builder = GetPlanRequestBuilder::new(_fbb);
    builder.add_id(args.id);
    builder.finish()
  }
  ...
  pub fn id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(GetPlanRequest::VT_ID, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for GetPlanRequest<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> Default for GetPlanRequestArgs {
  #[inline]
  fn default() -> Self {
    GetPlanRequestArgs {
      id: 0,
...
pub struct GetPlanRequestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetPlanRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: u64) {
    self.fbb_.push_slot::<u64>(GetPlanRequest::VT_ID, id, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> GetPlanRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    GetPlanRequestBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<GetPlanRequest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for GetPlanRequest<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("GetPlanRequest");
      ds.field("id", &self.id());
      ds.finish()
  }
}
...
pub enum StartPlanRequestOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct StartPlanRequest<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StartPlanRequest<'a> {
  type Inner = StartPlanRequest<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StartPlanRequest<'a> {
  pub const VT_ID: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StartPlanRequest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args StartPlanRequestArgs
  ) -> flatbuffers::WIPOffset<StartPlanRequest<'bldr>> {
    let mut builder = StartPlanRequestBuilder::new(_fbb);
    builder.add_id(args.id);
    builder.finish()
  }
  ...
  pub fn id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(StartPlanRequest::VT_ID, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StartPlanRequest<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> Default for StartPlanRequestArgs {
  #[inline]
  fn default() -> Self {
    StartPlanRequestArgs {
      id: 0,
    }
  }
}

pub struct StartPlanRequestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StartPlanRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: u64) {
    self.fbb_.push_slot::<u64>(StartPlanRequest::VT_ID, id, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> StartPlanRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    StartPlanRequestBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StartPlanRequest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StartPlanRequest<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StartPlanRequest");
      ds.field("id", &self.id());
      ds.finish()
  }
}
pub enum StartPlanResponseOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct StartPlanResponse<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StartPlanResponse<'a> {
  type Inner = StartPlanResponse<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StartPlanResponse<'a> {
  pub const VT_ALREADY_RUNNING: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StartPlanResponse { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args StartPlanResponseArgs
  ) -> flatbuffers::WIPOffset<StartPlanResponse<'bldr>> {
    let mut builder = StartPlanResponseBuilder::new(_fbb);
    builder.add_already_running(args.already_running);
    builder.finish()
  }
  ...
  pub fn already_running(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StartPlanResponse::VT_ALREADY_RUNNING, Some(false)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StartPlanResponse<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<bool>("already_running", Self::VT_ALREADY_RUNNING, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> Default for StartPlanResponseArgs {
  #[inline]
  fn default() -> Self {
...
pub struct StartPlanResponseBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StartPlanResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_already_running(&mut self, already_running: bool) {
    self.fbb_.push_slot::<bool>(StartPlanResponse::VT_ALREADY_RUNNING, already_running, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> StartPlanResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    StartPlanResponseBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StartPlanResponse<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StartPlanResponse<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StartPlanResponse");
      ds.field("already_running", &self.already_running());
      ds.finish()
  }
}
pub enum StopPlanRequestOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct StopPlanRequest<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StopPlanRequest<'a> {
  type Inner = StopPlanRequest<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StopPlanRequest<'a> {
  pub const VT_ID: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StopPlanRequest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args StopPlanRequestArgs
  ) -> flatbuffers::WIPOffset<StopPlanRequest<'bldr>> {
    let mut builder = StopPlanRequestBuilder::new(_fbb);
    builder.add_id(args.id);
    builder.finish()
  }
  ...
  pub fn id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(StopPlanRequest::VT_ID, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StopPlanRequest<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> Default for StopPlanRequestArgs {
  #[inline]
  fn default() -> Self {
    StopPlanRequestArgs {
      id: 0,
...
pub struct StopPlanRequestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StopPlanRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: u64) {
    self.fbb_.push_slot::<u64>(StopPlanRequest::VT_ID, id, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> StopPlanRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    StopPlanRequestBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StopPlanRequest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StopPlanRequest<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StopPlanRequest");
      ds.field("id", &self.id());
      ds.finish()
  }
}
pub enum StopPlanResponseOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct StopPlanResponse<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StopPlanResponse<'a> {
  type Inner = StopPlanResponse<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StopPlanResponse<'a> {
  pub const VT_ALREADY_STOPPED: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StopPlanResponse { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args StopPlanResponseArgs
  ) -> flatbuffers::WIPOffset<StopPlanResponse<'bldr>> {
    let mut builder = StopPlanResponseBuilder::new(_fbb);
    builder.add_already_stopped(args.already_stopped);
    builder.finish()
  }
  ...
  pub fn already_stopped(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StopPlanResponse::VT_ALREADY_STOPPED, Some(false)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StopPlanResponse<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<bool>("already_stopped", Self::VT_ALREADY_STOPPED, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> Default for StopPlanResponseArgs {
  #[inline]
  fn default() -> Self {
...
pub struct StopPlanResponseBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StopPlanResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_already_stopped(&mut self, already_stopped: bool) {
    self.fbb_.push_slot::<bool>(StopPlanResponse::VT_ALREADY_STOPPED, already_stopped, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> StopPlanResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    StopPlanResponseBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StopPlanResponse<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StopPlanResponse<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StopPlanResponse");
      ds.field("already_stopped", &self.already_stopped());
      ds.finish()
  }
}
...
impl<'a> Message<'a> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_create_plan_request(&self) -> Option<CreatePlanRequest<'a>> {
    if self.data_type() == Payload::CreatePlanRequest {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { CreatePlanRequest::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_create_plan_response(&self) -> Option<CreatePlanResponse<'a>> {
    if self.data_type() == Payload::CreatePlanResponse {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { CreatePlanResponse::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_delete_plan_request(&self) -> Option<DeletePlanRequest<'a>> {
    if self.data_type() == Payload::DeletePlanRequest {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { DeletePlanRequest::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_delete_plan_response(&self) -> Option<DeletePlanResponse<'a>> {
    if self.data_type() == Payload::DeletePlanResponse {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { DeletePlanResponse::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_start_plan_request(&self) -> Option<StartPlanRequest<'a>> {
    if self.data_type() == Payload::StartPlanRequest {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { StartPlanRequest::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_start_plan_response(&self) -> Option<StartPlanResponse<'a>> {
    if self.data_type() == Payload::StartPlanResponse {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { StartPlanResponse::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_stop_plan_request(&self) -> Option<StopPlanRequest<'a>> {
    if self.data_type() == Payload::StopPlanRequest {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { StopPlanRequest::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_stop_plan_response(&self) -> Option<StopPlanResponse<'a>> {
    if self.data_type() == Payload::StopPlanResponse {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { StopPlanResponse::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_get_plan_request(&self) -> Option<GetPlanRequest<'a>> {
    if self.data_type() == Payload::GetPlanRequest {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { GetPlanRequest::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_get_plans_request(&self) -> Option<GetPlansRequest<'a>> {
    if self.data_type() == Payload::GetPlansRequest {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
      Some(unsafe { GetPlansRequest::init_from_table(u) })
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn data_as_disconnect(&self) -> Option<Disconnect<'a>> {
    if self.data_type() == Payload::Disconnect {
      let u = self.data();
      // Safety:
      // Created from a valid Table for this object
      // Which contains a valid union in this slot
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_union::<Payload, _>("data_type", Self::VT_DATA_TYPE, "data", Self::VT_DATA, true, |key, v, pos| {
        match key {
          Payload::CreatePlanRequest => v.verify_union_variant::<flatbuffers::ForwardsUOffset<CreatePlanRequest>>("Payload::CreatePlanRequest", pos),
          Payload::CreatePlanResponse => v.verify_union_variant::<flatbuffers::ForwardsUOffset<CreatePlanResponse>>("Payload::CreatePlanResponse", pos),
          Payload::DeletePlanRequest => v.verify_union_variant::<flatbuffers::ForwardsUOffset<DeletePlanRequest>>("Payload::DeletePlanRequest", pos),
          Payload::DeletePlanResponse => v.verify_union_variant::<flatbuffers::ForwardsUOffset<DeletePlanResponse>>("Payload::DeletePlanResponse", pos),
          Payload::StartPlanRequest => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StartPlanRequest>>("Payload::StartPlanRequest", pos),
          Payload::StartPlanResponse => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StartPlanResponse>>("Payload::StartPlanResponse", pos),
          Payload::StopPlanRequest => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StopPlanRequest>>("Payload::StopPlanRequest", pos),
          Payload::StopPlanResponse => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StopPlanResponse>>("Payload::StopPlanResponse", pos),
          Payload::GetPlanRequest => v.verify_union_variant::<flatbuffers::ForwardsUOffset<GetPlanRequest>>("Payload::GetPlanRequest", pos),
          Payload::GetPlansRequest => v.verify_union_variant::<flatbuffers::ForwardsUOffset<GetPlansRequest>>("Payload::GetPlansRequest", pos),
          ...
          Payload::Disconnect => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Disconnect>>("Payload::Disconnect", pos),
          _ => Ok(()),
        }
     })?
...
impl core::fmt::Debug for Message<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("Message");
      ...
      match self.data_type() {
        Payload::CreatePlanRequest => {
          if let Some(x) = self.data_as_create_plan_request() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::CreatePlanResponse => {
          if let Some(x) = self.data_as_create_plan_response() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::DeletePlanRequest => {
          if let Some(x) = self.data_as_delete_plan_request() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::DeletePlanResponse => {
          if let Some(x) = self.data_as_delete_plan_response() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::StartPlanRequest => {
          if let Some(x) = self.data_as_start_plan_request() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::StartPlanResponse => {
          if let Some(x) = self.data_as_start_plan_response() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::StopPlanRequest => {
          if let Some(x) = self.data_as_stop_plan_request() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::StopPlanResponse => {
          if let Some(x) = self.data_as_stop_plan_response() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::GetPlanRequest => {
          if let Some(x) = self.data_as_get_plan_request() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::GetPlansRequest => {
          if let Some(x) = self.data_as_get_plans_request() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Payload::Disconnect => {
          if let Some(x) = self.data_as_disconnect() {
            ds.field("data", &x)
          } else {
            ds.field("data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
